...
import { _ as __assign, a as __spreadArray } from './tslib.es6-75bd0528.js';
...
var OpenChannelListProvider = function (_a) {
  ...
  var className = _a.className,
      ...
      queries = _a.queries,
      onChannelSelected = _a.onChannelSelected; // props
  ...
  }, [queries === null || queries === void 0 ? void 0 : queries.openChannelListQuery]); // dux
  ...
  var allChannels = openChannelListStore.allChannels,
      ...
      channelListQuery = openChannelListStore.channelListQuery; // Initialize
  ...
  useEffect(function () {
    ...
    subscriber === null || subscriber === void 0 ? void 0 : subscriber.set(UPDATE_OPEN_CHANNEL, pubSub === null || pubSub === void 0 ? void 0 : pubSub.subscribe(UPDATE_OPEN_CHANNEL, function (channel) {
      openChannelListDispatcher({
  ...
  }, [sdkInitialized, pubSub]); // Fetch next channels by scroll event
...
//# sourceMappingURL=OpenChannelListProvider-267577c1.js.map
